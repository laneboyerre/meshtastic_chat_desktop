...
class MeshtasticTkinterApp:
    ...
    def setup_ui(self):
        ...
        self.trace_route_button = ttk.Button(self.frame, text="Trace Route", command=self.trace_route)
        self.trace_route_button.grid(row=3, column=3, padx=10, pady=5)
